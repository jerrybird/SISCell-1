...
namespace SISCell
{
    ...
    //    where T:new()
    public class I_ModbusCOM: iProtocol
    {
        ...
        public void UnpackReceive(byte[] bytetemp, int startAddr, int len)
        {
            try
            {
                ...
                if (m_config_Modbus.m_ModbusType == "RTU")
                {
                    ...
                    {
                        RTU vtemp = new RTU(bytetemp, len, startAddr, dataType);
                ...
                {
                    ASCII vtemp = new ASCII(bytetemp, len, startAddr, dataType);
        ...
        private void tm_Elapsed(object sender, System.Timers.ElapsedEventArgs e)
        {
            try
            {
                ...
                if (SendList.Count > 0)
                {
                    ...
                    {
                        RTU rtuobj = (RTU)temp;
                        m_startAddr = rtuobj.Requestread.StartAddr + 1;
                    ...
                    if (m_config_Modbus.m_ModbusType == "ASCII")
                    {
                        ...
                        m_startAddr = ascobj.AscRtu.Requestread.StartAddr + 1;
    ...
    public class CONFG_Modbus
    {
        ...
        public CONFG_Modbus(string configFile)
        {
            SetConfig_Modbus(configFile);
            //switch (m_holdregType)
            //{
            //    case 2:
            //    case 3:
            //    case 6:
            //    case 7:
            //        if (m_holdregStartAddr % 2 == 0)
            //        {
            //            sw = File.AppendText(logfile);
            //            sw.WriteLine(DateTime.Now.ToString() + " HoldReg_StartAddr Error!");
            //            sw.Close();
            //            throw new Exception("HoldReg_StartAddr Error!");
            //        }
            //        //if (m_holdregLen % 2 > 0)
            //        //{
            //        //    sw = File.AppendText(logfile);
            //        //    sw.WriteLine(DateTime.Now.ToString() + " HoldReg_Len Error!");
            //        //    sw.Close();
            //        //    throw new Exception("HoldReg_Len Error!");
            //        //}
            //        if (m_holdregLen > 0)
            //        {
            //            m_holdregLen = m_holdregLen * 2;
            //        }
            //        break;
            //    case 4:
            //    case 8:
            //        if ((m_holdregStartAddr - 1) % 4 == 0) { }
            //        else
            //        {
            //            sw = File.AppendText(logfile);
            //            sw.WriteLine(DateTime.Now.ToString() + " HoldReg_StartAddr Error!");
            ...
            ////{
            ////    sw = File.AppendText(logfile);
            ////    sw.WriteLine(DateTime.Now.ToString() + " HoldtReg_Len Error!");
            ////    sw.Close();
            ////    throw new Exception("HoldtReg_Len Error!");
            ////}
            //if (m_holdregLen > 0)
            //{
            //    m_holdregLen = m_holdregLen * 4;
            //}
            //break;
            //}
            //switch (m_inputregType)
            //{
            //    case 2:
            //    case 3:
            //    case 6:
            //    case 7:
            //        if (m_inputregStartAddr % 2 == 0)
            //        {
            //            sw = File.AppendText(logfile);
            //            sw.WriteLine(DateTime.Now.ToString() + " InputReg_StartAddr Error!");
            //            sw.Close();
            //            throw new Exception("InputReg_StartAddr Error!");
            //        }
            //        //if (m_inputregLen % 2 > 0)
            //        //{
            //        //    sw = File.AppendText(logfile);
            //        //    sw.WriteLine(DateTime.Now.ToString() + " InputReg_Len Error!");
            //        //    sw.Close();
            //        //    throw new Exception("InputReg_Len Error!");
            //        //}
            //        if (m_inputregLen > 0)
            //        {
            //            m_inputregLen = m_inputregLen * 2;
            //        }
            //        break;
            //    case 4:
            //    case 8:
            //        if ((m_inputregStartAddr - 1) % 4 == 0) { }
            //        else
            //        {
            //            sw = File.AppendText(logfile);
            //            sw.WriteLine(DateTime.Now.ToString() + " InputReg_StartAddr Error!");
